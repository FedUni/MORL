// Modified version of Space Trader with -1 Reward
package env;
...
public class SpaceTradersV2 implements EnvironmentInterface
{  
    ...
    {
        EnvironmentLoader theLoader = new EnvironmentLoader(new SpaceTradersV2());
        theLoader.run();
    }
